...
export function PauseIndicator({ isWaiting }: PauseIndicatorProps) {
  return (
    ...
    >
      <span className="bg-navy-dark/50 text-cream backdrop-blur px-4 py-2 rounded-full text-sm tracking-widest uppercase flex items-center gap-2 shadow-inner border border-gold/15 font-sans">
