    ...
    mysteries: [
      {
        ...
        meditation:
          "Contemplemos o Batismo de Jesus no rio Jordão.",
        image: "/images/themes/luminosos.jpg",
      },
      {
        title: "A Auto-revelação de Jesus nas Bodas de Caná",
        meditation:
          "Contemplemos a Auto-revelação de Jesus nas Bodas de Caná.",
        image: "/images/themes/luminosos.jpg",
      },
      {
        title: "O Anúncio do Reino de Deus",
        meditation:
          "Contemplemos o Anúncio do Reino de Deus.",
        image: "/images/themes/luminosos.jpg",
      },
      {
        title: "A Transfiguração de Jesus",
        meditation:
          "Contemplemos a Transfiguração de Jesus.",
        image: "/images/themes/luminosos.jpg",
      },
      {
        title: "A Instituição da Eucaristia",
        meditation:
          "Contemplemos a Instituição da Eucaristia.",
        image: "/images/themes/luminosos.jpg",
      },
    ],
  },
    ...
    mysteries: [
      {
        ...
        meditation:
          "Contemplemos a Agonia de Cristo Nosso Senhor, quando suou sangue no Horto.",
        image: "/images/themes/dolorosos.jpg",
      },
      {
        title: "A Flagelação de Jesus Cristo",
        meditation:
          "Contemplemos a Flagelação de Jesus Cristo atado à coluna.",
        image: "/images/themes/dolorosos.jpg",
      },
      {
        title: "A Coroação de Espinhos",
        meditation:
          "Contemplemos a Coroação de espinhos de Nosso Senhor.",
        image: "/images/themes/dolorosos.jpg",
      },
      {
        title: "Jesus Carrega a Cruz para o Calvário",
        meditation:
          "Contemplemos Jesus Cristo carregando a Cruz para o Calvário.",
        image: "/images/themes/dolorosos.jpg",
      },
      {
        title: "A Crucificação e Morte de Nosso Senhor",
        meditation:
          "Contemplemos a Crucificação e morte de Nosso Senhor Jesus Cristo.",
        image: "/images/themes/dolorosos.jpg",
      },
    ],
  },
    ...
    mysteries: [
      {
        ...
        meditation:
          "Contemplemos a Ressurreição de Cristo Nosso Senhor.",
        image: "/images/themes/gloriosos.jpg",
      },
      {
        title: "A Ascensão de Nosso Senhor ao Céu",
        meditation:
          "Contemplemos a Ascensão de Nosso Senhor ao Céu.",
        image: "/images/themes/gloriosos.jpg",
      },
      {
        title: "A Vinda do Espírito Santo",
        meditation:
          "Contemplemos a Vinda do Espírito Santo sobre os Apóstolos reunidos com Maria Santíssima no Cenáculo em Jerusalém.",
        image: "/images/themes/gloriosos.jpg",
      },
      {
        title: "A Assunção de Nossa Senhora ao Céu",
        meditation:
          "Contemplemos a Assunção de Nossa Senhora ao Céu.",
        image: "/images/themes/gloriosos.jpg",
      },
      {
        title: "A Coroação de Nossa Senhora",
        meditation:
          "Contemplemos a Coroação de Nossa Senhora no Céu como Rainha de todos os anjos e santos.",
        image: "/images/themes/gloriosos.jpg",
      },
    ],
  },
