    ...
    mysteries: [
      {
        ...
        image: "/images/luminosos/1-misterio.webp",
        background: "/images/luminosos/1-fundo.webp",
      },
      {
        title: "A Auto-revelação de Jesus nas Bodas de Caná",
        meditation: "Contemplemos a Auto-revelação de Jesus nas Bodas de Caná.",
        image: "/images/luminosos/2-misterio.webp",
        background: "/images/luminosos/2-fundo.webp",
      },
      {
        title: "O Anúncio do Reino de Deus",
        meditation: "Contemplemos o Anúncio do Reino de Deus.",
        image: "/images/luminosos/3-misterio.webp",
        background: "/images/luminosos/3-fundo.webp",
      },
      {
        title: "A Transfiguração de Jesus",
        meditation: "Contemplemos a Transfiguração de Jesus.",
        image: "/images/luminosos/4-misterio.webp",
        background: "/images/luminosos/4-fundo.webp",
      },
      {
        title: "A Instituição da Eucaristia",
        meditation: "Contemplemos a Instituição da Eucaristia.",
        image: "/images/luminosos/5-misterio.webp",
        background: "/images/luminosos/5-fundo.webp",
      },
    ],
  },
  dolorosos: {
    ...
    mysteries: [
      {
        ...
        image: "/images/gloriosos/1-misterio.webp",
        background: "/images/gloriosos/1-fundo.webp",
      },
      {
        title: "A Ascensão de Nosso Senhor ao Céu",
        meditation: "Contemplemos a Ascensão de Nosso Senhor ao Céu.",
        image: "/images/gloriosos/2-misterio.webp",
        background: "/images/gloriosos/2-fundo.webp",
      },
      {
        ...
        image: "/images/gloriosos/3-misterio.webp",
        background: "/images/gloriosos/3-fundo.webp",
      },
      {
        title: "A Assunção de Nossa Senhora ao Céu",
        meditation: "Contemplemos a Assunção de Nossa Senhora ao Céu.",
        image: "/images/gloriosos/4-misterio.webp",
        background: "/images/gloriosos/4-fundo.webp",
      },
      {
        ...
        image: "/images/gloriosos/5-misterio.webp",
        background: "/images/gloriosos/5-fundo.webp",
      },
    ],
  },
};
